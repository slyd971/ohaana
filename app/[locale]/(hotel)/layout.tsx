...
import {
  LayoutDashboard, Link2, CreditCard,
  BarChart3, Settings, LogOut, Menu,
} from 'lucide-react'

const NAV = [
  { href: '/hotel/dashboard',     label: 'Tableau de bord', Icon: LayoutDashboard },
  { href: '/hotel/partner-link',  label: 'Lien partenaire', Icon: Link2 },
  { href: '/hotel/referrals',     label: 'Réservations',    Icon: BarChart3 },
  { href: '/hotel/commissions',   label: 'Commissions',     Icon: CreditCard },
  { href: '/hotel/settings',      label: 'Paramètres',      Icon: Settings },
]
...
export default function HotelLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-dvh flex bg-sand">
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 w-60 bg-[#2C3E50] flex flex-col transition-transform duration-300',
      ...
      >
        <div className="px-5 py-5 border-b border-coconut/10">
          ...
          <p className="text-coconut/40 text-[11px] mt-1 uppercase tracking-widest">Espace hôtel / villa</p>
        </div>
